package com.ferdidrgn.theatreticket._notDefteri

class NotDefteri {
    //Cutom button a image koymayı ayarla
    ...
    //bazı veriler app li bazıları app siz açlışyor. CustomDatautillere bir bak
