...
class CustomEditText : ConstraintLayout {
    ...
    private fun initLayout(context: Context, attributeSet: AttributeSet?, style: Int?) {
        ...
        textType(layoutAttribute.getInt(R.styleable.CustomEditText_custom_edit_input, 0))
    ...
    private fun textType(text: Int) {
        val inputTypeText = findViewById<TextInputEditText>(R.id.etCustomEditText)
